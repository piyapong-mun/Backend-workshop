...
// Source: github.com/piyapong-mun/simplebank/db/sqlc (interfaces: Store)
...
func (m *MockStore) DeleteEntry(arg0 context.Context, arg1 uuid.UUID) error {
	m.ctrl.T.Helper()
...
func (m *MockStore) DeleteTransfers(arg0 context.Context, arg1 uuid.UUID) error {
	m.ctrl.T.Helper()
...
func (m *MockStore) GetTransfers(arg0 context.Context, arg1 uuid.UUID) (db.Transfer, error) {
	m.ctrl.T.Helper()
